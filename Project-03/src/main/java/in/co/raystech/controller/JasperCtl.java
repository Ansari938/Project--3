	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			JasperReport jasperReport = JasperCompileManager
					.compileReport("D:\\project for all rays tecnologye\\rays tecnolgies projcect\\Project-03-main\\Project-03-main\\Project-03\\src\\main\\webapp\\jasper\\jaspermerit.jrxml");
